...
// The per-type extensions live in their own file. They reach `_softly`,
// `_actual` and `_label`, which are library-private, so this is a `part`
// rather than a separate library — splitting it any other way would mean
// widening that API just to move code.
part 'assert_d_extensions.dart';
