...
class CartSteps {
  ...
  /// replaces the input).
  Future<void> applyValidCoupon(String code) async {
  ...
  Future<void> checkoutWithCard({required String addressId}) async {
    expect(
  ...
  Future<void> expectEmptyCart() async {
    await _cart.waitUntilVisible();
    expect(
